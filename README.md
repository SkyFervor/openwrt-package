...
添加 "src-git lienol https://github.com/dong50252409/openwrt-package" 到 OpenWRT源码根目录feeds.conf.default文件
...
Add "src-git lienol https://github.com/dong50252409/openwrt-package" to feeds.conf.default.
